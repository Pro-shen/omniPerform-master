...
import com.omniperform.common.utils.CookieUtils;
...
public class SysIndexController extends BaseController
{
    ...
    public String index(ModelMap mmap, HttpServletRequest request)
    {
        ...
        mmap.put("copyrightYear", com.omniperform.common.config.OmniperformConfig.getCopyrightYear());
        mmap.put("demoEnabled", com.omniperform.common.config.OmniperformConfig.isDemoEnabled());
    ...
    {
        mmap.put("version", com.omniperform.common.config.OmniperformConfig.getVersion());
        return "main";
    }
