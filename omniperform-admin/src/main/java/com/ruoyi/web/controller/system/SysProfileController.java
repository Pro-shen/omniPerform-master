package com.omniperform.web.controller.system;
...
import com.omniperform.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult updateAvatar(@RequestParam("avatarfile") MultipartFile file)
    {
        ...
        try
        {
            if (!file.isEmpty())
            {
                String avatar = FileUploadUtils.upload(com.omniperform.common.config.OmniperformConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
